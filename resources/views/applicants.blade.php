        ...
        <div class="box-body table-responsive px-10 py-0">
            <table class="table table-hover">
                <tbody>
                    ...
                    @if ( $item->blacklisted == false )
                    <tr>
                        <td><a class="label btn-warning" data-toggle="modal"
                            data-target="#modal-applicant-{{ $item->id}}"
                            href="">{{ $item->fname}} {{ $item->lname}}</a>
							<div class="modal modal-primary fade" id="modal-applicant-{{ $item->id}}"
                            style="display: none;">
                            <div class="modal-dialog widthi">
                                <div class="modal-contents">
									...
									<ul class="nav nav-tabs">
											...
											<li class="active"><a class="navcolor" data-toggle="tab" href="#home{{ $item->id}}">Applicant Details</a></li>
											<li><a class="navcolor" data-toggle="tab" href="#note{{ $item->id}}">Interviewer Notes</a></li>
											<li><a class="navcolor" data-toggle="tab" href="#question{{ $item->id}}">Interview Questions 1</a></li>
											<li><a class="navcolor" data-toggle="tab" href="#quiz{{ $item->id}}">Quiz</a></li>
										  </ul>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="text-white" target="_blank"
                                                            href="{{url('careers_data')}}/{{$item->resume}}">Download</a>
                                                    </td>
                                                    <td>{{ $item->note_for_interviewer}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
											</div>
											<div id="note{{ $item->id}}" class="tab-pane fade pt10">
											 <div class="col-md-6">
											 
											 @foreach ($notes->where('applicant_id', $item->id) as $note)
										...
										{{ Form::hidden('careers_user', $item->id, array('class' => 'form-control','required'=>'true',)) }}
										...
										{!! Form::close() !!}
											...
											<div id="question{{ $item->id}}" class="tab-pane fade">
											{!! Form::open(['action' => 'ApplicantController@scoreSave','id'=>'form']) !!}
										{{ Form::token() }}
										
										{{ Form::hidden('careers_user', $item->id, array('class' => 'form-control')) }}
											  <table class="table bg-transparent table-bordered">
                                            <tbody>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{!! Form::radio($item->id.'que1', '10',null)
													!!} <label class="pr5" for="{{$item->id}}que1">10</label> 
													{!! Form::radio($item->id.'que1', '7',null)
													!!} <label class="pr5" for="{{$item->id}}que1">7</label> 
													{!! Form::radio($item->id.'que1', '5',null)
													!!} <label class="pr5" for="{{$item->id}}que1">5</label>  
													{!! Form::radio($item->id.'que1', '3',null)
													!!} <label class="pr5" for="{{$item->id}}que1">3</label> 
													{!! Form::radio($item->id.'que1', '0',null)
													!!} <label class="pr5" for="{{$item->id}}que1">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($item->id.'que2', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$item->id}}que2">10</label> 
													{{ Form::radio($item->id.'que2', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que2">7</label> 
													{{ Form::radio($item->id.'que2', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que2">5</label>  
													{{ Form::radio($item->id.'que2', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que2">3</label> 
													{{ Form::radio($item->id.'que2', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que2">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($item->id.'que3', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$item->id}}que3">10</label> 
													{{ Form::radio($item->id.'que3', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que3">7</label> 
													{{ Form::radio($item->id.'que3', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que3">5</label>  
													{{ Form::radio($item->id.'que3', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que3">3</label> 
													{{ Form::radio($item->id.'que3', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que3">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($item->id.'que4', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$item->id}}que4">10</label> 
													{{ Form::radio($item->id.'que4', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que4">7</label> 
													{{ Form::radio($item->id.'que4', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que4">5</label>  
													{{ Form::radio($item->id.'que4', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que4">3</label> 
													{{ Form::radio($item->id.'que4', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que4">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($item->id.'que5', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$item->id}}que5">10</label> 
													{{ Form::radio($item->id.'que5', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que5">7</label> 
													{{ Form::radio($item->id.'que5', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que5">5</label>  
													{{ Form::radio($item->id.'que5', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que5">3</label> 
													{{ Form::radio($item->id.'que5', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que5">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($item->id.'que6', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$item->id}}que6">10</label> 
													{{ Form::radio($item->id.'que6', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que6">7</label> 
													{{ Form::radio($item->id.'que6', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que6">5</label>  
													{{ Form::radio($item->id.'que6', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que6">3</label> 
													{{ Form::radio($item->id.'que6', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que6">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($item->id.'que7', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$item->id}}que7">10</label> 
													{{ Form::radio($item->id.'que7', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que7">7</label> 
													{{ Form::radio($item->id.'que7', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que7">5</label>  
													{{ Form::radio($item->id.'que7', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que7">3</label> 
													{{ Form::radio($item->id.'que7', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que7">0</label> 
													</td>
							        ...
							        <span class="coupontooltip">
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($item->id.'que8', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$item->id}}que8">10</label> 
													{{ Form::radio($item->id.'que8', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que8">7</label> 
													{{ Form::radio($item->id.'que8', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que8">5</label>  
													{{ Form::radio($item->id.'que8', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que8">3</label> 
													{{ Form::radio($item->id.'que8', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$item->id}}que8">0</label> 
													</td>
										...
										{!! Form::close() !!}
											...
											<div id="quiz{{ $item->id}}" class="tab-pane fade">
												@foreach ($scores->where('applicant', $item->id) as $score)
										@php
										   $s = $score->score;
                                           $s = explode( ',', $s );
					...
					@endforeach 
                        ...
                        <td>
						@if ($item->resume != "")<a target="_blank"
                                                            href="{{url('careers_data')}}/{{$item->resume}}">Download</a>
									@else --
									@endif
                        </td>
                        <td>N/A <a href="applicants-blacklist/{{$item->id}}"> <b>Add Now</b></a></td>
                        <td>{{ $job[$item->job_position]}}</td>
                        <td>{{ $item->city }}, {{ $item->city }}</td>
                        <td>{{ $item->time_on_steps_page }}</td>
                        <td>{{ date('M jS Y, h:ia',strtotime($item->created_at)) }}</td>
                        <td>{{' -- '}}</td>
                        <td>
						@php $sum = 0; @endphp
						@foreach ($scores->where('applicant',$item->id) as $score) 
						...
						@endphp
						@endforeach{{$sum}}</td>
                        <td>@foreach ($refer->where('shortcode',$item->refer_id) as $ref)
            ...
            <div class="px-10 py-0"> {{ $applicant->links() }}</div>
        </div>
        <!-- /.box-body -->
    </div>
    <!-- /.box -->
