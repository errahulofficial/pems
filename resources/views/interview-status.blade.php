...
<div class="col-md-5">
    <div class="box box-primary">
        ...
        {!! Form::open(['action' => 'interviewStatus@store','id'=>'form']) !!} {{ Form::token() }}
        <div class="box-body">
            <div class="row">
...
<div class="col-md-8 d-flex">
      ...
      @foreach ($interviewStatus as $interviewStatusView)
                <tr>
                  <td>{{ $interviewStatusView->interviewstatus_name}}</td>
                  <td class="text-center">
                        <span class="d-flex" style="background:{{ $interviewStatusView->interviewstatus_colorcode}};width:25px;height:25px;border-radius:50%;"></span>
                        </td>
                  <td>{{ $interviewStatusView->jobposition_name}}</td>
                  <td>{{ $interviewStatusView->jobpositionstep_stepname}}</td>
                  <td>
                      


                      <a href="{{ url('interview-status-email') }}/{{ $interviewStatusView->interviewstatusid}}"
                      class="label label-warning">EMAIL SETUP<i
                      class="fa fa-pencil "></i></a>
                    </td>
                  <td>

                    <a href="{{ url('interview-status/edit') }}/{{ $interviewStatusView->interviewstatusid}}"
                    class="label label-success"><i
                    class="fa fa-pencil "></i></a>
               
                                    <a data-toggle="modal"
                                        data-target="#modal-view-delete-{{ $interviewStatusView->interviewstatusid}}"
                                        class="label label-danger"> <i
                                        class="fa fa-trash "></i></a>
                                    <div class="modal modal-danger fade"
                                        id="modal-view-delete-{{ $interviewStatusView->interviewstatusid}}"
                                        style="display: none;">
                                        <div class="modal-dialog">
                                            <div class="modal-contents">
                                                ...
                                                <div class="modal-body">
                                                        <a href="{{ url('interview-status/delete') }}/{{ $interviewStatusView->interviewstatusid}}">
      ...
      @endforeach
            ...
            <div class="px-10 py-0"> {{ $interviewStatus->links() }}</div>
          </div>
          <!-- /.box-body -->
        </div>
        <!-- /.box -->
