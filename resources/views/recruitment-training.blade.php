                    ...
                    <div class="box-body table-responsive px-10 py-0">
                        ...
                        <table class="table table-hover">
                            <tbody>
                                ...
                                @foreach ($publicationsView->recruitment_training_database_model as $language)
                                ...
                                <td><a target="_blank" href="{{url('')}}/recruitment_training/{{ $language->documents}}">Download/View</a> </td>
