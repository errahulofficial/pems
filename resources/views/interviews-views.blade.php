    ...
    <div class="box box-primary">
        ...
        <table class="table table-hover">
            <tbody>
                ...
                @foreach($applicants as $applicantsView)
                <tr>
                    <td style="background:{{ $applicantsView->colorcode}}">
                        <div style="background:transparent;padding:2px 5px;border-radius:10px;color:#fff">
                            {{$applicantsView->add_interviewer_jobpositions_stepsCheck_steps_name}}
                            - {{$applicantsView->interviewstatusName}}
                            <br />
                            {{ $applicantsView->jobpositionNameGet}}
                    ...
                    <td>
                        ...
                        <a class="label btn-warning" data-toggle="modal"
                            data-target="#modal-applicant-{{ $applicantsView->careers_usersId}}"
                            href="">{{ $applicantsView->careers_usersFname}}
                            {{ $applicantsView->careers_usersLname}}</a>
                        <div class="modal modal-primary fade" id="modal-applicant-{{ $applicantsView->careers_usersId}}"
                            style="display: none;">
                            <div class="modal-dialog widthi">
                                <div class="modal-contents">
									...
									<ul class="nav nav-tabs">
											...
											<li class="active"><a class="navcolor" data-toggle="tab" href="#home{{ $applicantsView->careers_usersId}}">Applicant Details</a></li>
											<li><a class="navcolor" data-toggle="tab" href="#note{{ $applicantsView->careers_usersId}}">Interviewer Notes</a></li>
											<li><a class="navcolor" data-toggle="tab" href="#question{{ $applicantsView->careers_usersId}}">Interview Questions 1</a></li>
											<li><a class="navcolor" data-toggle="tab" href="#quiz{{ $applicantsView->careers_usersId}}">Quiz</a></li>
										  </ul>

										  <div class="tab-content">
											<div id="home{{ $applicantsView->careers_usersId}}" class="tab-pane fade in active">
                                        ...
                                        <table class="table bg-transparent table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $applicantsView->careers_usersFname}}</td>
                                                    <td>{{ $applicantsView->careers_usersLname}}</td>
                                                    <td>{{ $applicantsView->careers_usersphone}}</td>
                                                    <td>{{ $applicantsView->careers_usersemail}}</td>
                                                    <td>{{ $applicantsView->careers_userscity}}</td>
                                                    <td>{{ $applicantsView->careers_usersstate}}</td>
                                                    <td>{{ $applicantsView->careers_userszipcode}}</td>
                                                    <td>
                                                        <a class="text-white" target="_blank"
                                                            href="{{url('careers_data')}}/{{$applicantsView->careers_usersresume}}">Download</a>
                                                    </td>
                                                    <td>{{ $applicantsView->careers_usersnote_for_interviewer}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
											</div>
											<div id="note{{ $applicantsView->careers_usersId}}" class="tab-pane fade pt10">
											 <div class="col-md-6">
											 
											 @foreach ($notes->where('applicant_id', $applicantsView->careers_usersId) as $note)
												
													<div class='card border1'>
												<span><b>{{$note->interviewer_fname}} {{$note->interviewer_lname}}</b></span><br>
												<span>{{$note->created_at}}</span>
												<p class="font18">{{$note->descp}}</p>
												</div>											
											 @endforeach
											 ...
											 <div class="col-md-6">
											 {!! Form::open(['action' => 'ApplicantController@submitNotes','id'=>'form']) !!}
										{{ Form::token() }}
												
										{{ Form::hidden('careers_user', $applicantsView->careers_usersId, array('class' => 'form-control','required'=>'true',)) }}
										
												<div class="col form-group">
													<label for="title">Title</label> {{ Form::text('title', '',array('class' => 'form-control','placeholder' => 'Title','required'=>'true'))
													}}

												</div>
												<div class="col form-group">
													<label for="title">Description</label> {{ Form::textarea('description', '',array('class' => 'form-control','placeholder' => 'Description','required'=>'true'))
													}}
										...
										{!! Form::close() !!}
											...
											<div id="question{{ $applicantsView->careers_usersId}}" class="tab-pane fade">
											{!! Form::open(['action' => 'ApplicantController@scoreSave','id'=>'form']) !!}
										{{ Form::token() }}
										
										{{ Form::hidden('careers_user', $applicantsView->careers_usersId, array('class' => 'form-control')) }}
											  <table class="table bg-transparent table-bordered">
                                            <tbody>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{!! Form::radio($applicantsView->careers_usersId.'que1', '10',null)
													!!} <label class="pr5" for="{{$applicantsView->careers_usersId}}que1">10</label> 
													{!! Form::radio($applicantsView->careers_usersId.'que1', '7',null)
													!!} <label class="pr5" for="{{$applicantsView->careers_usersId}}que1">7</label> 
													{!! Form::radio($applicantsView->careers_usersId.'que1', '5',null)
													!!} <label class="pr5" for="{{$applicantsView->careers_usersId}}que1">5</label>  
													{!! Form::radio($applicantsView->careers_usersId.'que1', '3',null)
													!!} <label class="pr5" for="{{$applicantsView->careers_usersId}}que1">3</label> 
													{!! Form::radio($applicantsView->careers_usersId.'que1', '0',null)
													!!} <label class="pr5" for="{{$applicantsView->careers_usersId}}que1">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($applicantsView->careers_usersId.'que2', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que2">10</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que2', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que2">7</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que2', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que2">5</label>  
													{{ Form::radio($applicantsView->careers_usersId.'que2', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que2">3</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que2', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que2">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($applicantsView->careers_usersId.'que3', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que3">10</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que3', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que3">7</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que3', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que3">5</label>  
													{{ Form::radio($applicantsView->careers_usersId.'que3', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que3">3</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que3', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que3">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($applicantsView->careers_usersId.'que4', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que4">10</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que4', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que4">7</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que4', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que4">5</label>  
													{{ Form::radio($applicantsView->careers_usersId.'que4', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que4">3</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que4', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que4">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($applicantsView->careers_usersId.'que5', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que5">10</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que5', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que5">7</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que5', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que5">5</label>  
													{{ Form::radio($applicantsView->careers_usersId.'que5', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que5">3</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que5', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que5">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($applicantsView->careers_usersId.'que6', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que6">10</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que6', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que6">7</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que6', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que6">5</label>  
													{{ Form::radio($applicantsView->careers_usersId.'que6', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que6">3</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que6', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que6">0</label> 
													</td>
                                        ...
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($applicantsView->careers_usersId.'que7', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que7">10</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que7', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que7">7</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que7', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que7">5</label>  
													{{ Form::radio($applicantsView->careers_usersId.'que7', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que7">3</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que7', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que7">0</label> 
													</td>
							        ...
							        <span class="coupontooltip">
                                        <table class="table bg-transparent table-bordered"><b>Score</b>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding:3px">
													...
													{{ Form::radio($applicantsView->careers_usersId.'que8', '10',false, array('class' => 'form-control','required'=>'true',))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que8">10</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que8', '7',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que8">7</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que8', '5',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que8">5</label>  
													{{ Form::radio($applicantsView->careers_usersId.'que8', '3',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que8">3</label> 
													{{ Form::radio($applicantsView->careers_usersId.'que8', '0',false, array('class' => 'form-control'))
													}} <label class="pr5" for="{{$applicantsView->careers_usersId}}que8">0</label> 
													</td>
										...
										{!! Form::close() !!}
											...
											<div id="quiz{{ $applicantsView->careers_usersId}}" class="tab-pane fade">
												@foreach ($scores->where('applicant', $applicantsView->careers_usersId) as $score)
										@php
										   $s = $score->score;
                                           $s = explode( ',', $s );
                    ...
                    @endphp
                    <td>{{ $applicantsView->time_on_steps_page }}s</td>
                    ...
                    @endphp
                    <td>{{ $applicantsView->time_on_survey_page}}s</td>
                    <td>
                        @php
                        ...
                        Correct: {{ $applicantsView->careers_userssurvey_questions_correct}}, Wrong:
                        {{ $applicantsView->careers_userssurvey_questions_wrong}} </td>

                    <td>
                        <a class="label btn-warning" data-toggle="modal"
                            data-target="#modal-interviewer-{{ $applicantsView->careers_usersId}}"
                            href="">{{ $applicantsView->employeeFname}} {{ $applicantsView->employeeNname}}</a>
                        <div class="modal modal-primary fade"
                            id="modal-interviewer-{{ $applicantsView->careers_usersId}}" style="display: none;">
                                ...
                                <div class="modal-contents">
                                    <div class="modal-header">
                                        ...
                                        <div class="box-body">
                                            <div class="row">
                                                <div class="form-group">
                                                    {{ Form::select('interviewer',$addinterviewerArray, NULL, array('class'=>'form-control','id'=>'jobposition')) }}
                                                </div>
                                                ...
                                                <div class="form-group d-flex">
                                                    {{ Form::submit('Assign',array('class' => 'btn btn-success')) }}
                                                </div>
                                            </div>
                                        </div>
                                        {!! Form::close() !!}
                    ...
                    <td>{{ $applicantsView->day}} {{ $applicantsView->interview_date}} at
                        {{ $applicantsView->careers_usersInterview_time_select}}:00</td>
                    <td>
                        <a style="background:{{ $applicantsView->colorcode}}" class="label btn-warning"
                            data-toggle="modal" data-target="#modal-status-{{ $applicantsView->careers_usersId}}"
                            href="">{{$applicantsView->interviewstatusName}} </a>
                        <div class="modal modal-primary fade" id="modal-status-{{ $applicantsView->careers_usersId}}"
                            style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-contents">
                                    <div class="modal-header">
                                        ...
                                        <div class="box-body">
                                            <div class="row">
                                                <div class="form-group">
                                                    {{ Form::select('status',$interviewStatusArray, NULL, array('class'=>'form-control','id'=>'jobposition')) }}
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    {{ Form::textarea('city', '',array('class' => 'form-control','placeholder'
                                                                    => '')) }}
                                                </div>
                    ...
                    <td>
                        ...
                        <a class="label btn-warning" data-toggle="modal"
                            data-target="#modal-reschedule-{{ $applicantsView->careers_usersId}}" href="">Reschedule</a>
                        <div class="modal modal-primary fade"
                            id="modal-reschedule-{{ $applicantsView->careers_usersId}}" style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-contents">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        ...
                                        <p></p>
                                        <a target="_blank"
                                            href="{{url('interviews/view')}}/{{ $applicantsView->careers_usersId}}/{{$jobposition}}/{{$status}}/{{$applicantsView->careers_usersemployee_id}}/{{$from_date}}/{{$to_date}}/reschedule">
                    ...
                    <td>
                        <a class="label label-danger" data-toggle="modal"
                            data-target="#modal-delete-{{ $applicantsView->careers_usersId}}">Delete</a>




                        <div class="modal modal-primary fade" id="modal-delete-{{ $applicantsView->careers_usersId}}"
                            style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-contents">
                                    <div class="modal-header">
                                        ...
                                        <p></p>
                                        <a target=""
                                            href="{{url('interviews/view/delete')}}/{{ $applicantsView->careers_usersId}}">
                    ...
                    <td>
                        <a class="label label-success" data-toggle="modal"
                            data-target="#modal-mail-{{ $applicantsView->careers_usersId}}">Send</a>
               
                        <div class="modal modal-success fade" id="modal-mail-{{ $applicantsView->careers_usersId}}"
                            style="display: none;">
                            <div class="modal-dialog">
                                <div class="modal-contents">
                                    <div class="modal-header">
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">×</span></button>
                                        <h4 class="modal-title">Send Email of {{$applicantsView->interviewstatusName}}
                                            Status</h4>
                                        <p></p>
                                        <a
                                            href="{{url('interviews/send/email')}}/{{ $applicantsView->careers_usersId}}">
...
<script>
    $(document).ready(function () {
        ...
        $('select[name="jobposition"]').on('change', function () {
            ...
            if (jobpositionid) {
                $.ajax({
                    url: "{{ url('jobposition/interviewer/get')}}" + '/' + jobpositionid,
                    type: "GET",
                    dataType: "json",
...
<script>
    $(document).ready(function() {
           $('select[name="jobposition"]').on('change', function(){
                   ...
                   if(jobpositionid) {
                       $.ajax({
                           url: "{{ url('interviewer/get')}}" + '/' + jobpositionid,
                           type:"GET",
                           dataType:"json",
                            success:function(data) {
