...
<style>
    ...
    <div class="row">
        ...
        <div class="col-md-6 d-flex">
            <div class="p-20 bg-w">
                <div class="row d-flex">
                    <div class="col-md-4 text-center">
                        <img src="{{url('img/skype.png')}}" alt="">
                    </div>
                    <div class="com-md-8">
                        <p> <strong>Business-only Skype Address</strong></p>
                        <p><strong>Your Skype ID:</strong>@if (Auth::user()->skypeid == '') Not Created Yet @else {{Auth::user()->skypeid}} @endif</p>
                        </p><strong>Your Skype Password:</strong> @if (Auth::user()->skypeid == '') Not Created Yet @else {{Auth::user()->password_text}} @endif</p>
                        <div class=" warn p-20 d-flex">
                            <span><i class="fa fa-info"></i> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
                            <p>
        ...
        <div class="col-md-6 bg-w d-flex">
            <div class="p-20 bg-w">
                <div class="row d-flex">
                    <div class="col-md-12">
                        <img src="{{url('img/mikogo-logo.png')}}" alt="">
                    </div>
    ...
    {!! Form::open(['action' => ['email_skype@update'],'id'=>'form']) !!}
    {{ Form::token() }}
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            {{ Form::textarea('descp', $da ,array('class' => 'form-control ckeditor','id' => 'editorblog','placeholder'
