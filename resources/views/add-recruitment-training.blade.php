...
<div class="col-md-5 d-flex">
    ...
    <div class="box box-primary">
        ...
        {!! Form::open(['action' => 'recruitmentTrainingDatabase@create','id'=>'form','files'=>'true',]) !!} 
        {{ Form::token() }}
        <div class="box-body">
            <div class="row">
                ...
                <div class="col-md-12 form-group">
                    ...
                    {{ Form::select('recruitment_training_category_id',$selectrecruitment_training_category,NULL,array('class'=>'form-control','required'=>'true'))
                    }}
                </div>
                ...
                <div class="col-md-12 form-group">
                    {{ Form::submit('ADD RECRUITMENT TRAINING',array('class' => 'btn btn-success')) }}
                </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-contents">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ url('add-recruitment-training/delete') }}/{{ $categoryView->recruitment_training_category_id}}"><button type="button" class="btn btn-outline">Sure to Delete !</button></a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
                            ...
                            <div class="modal modal-success fade" id="modal-edit-{{ $categoryView->recruitment_training_category_id}}" style="display: none;">
                                <div class="modal-dialog">
                                    <div class="modal-contents">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-outline pull-left" data-dismiss="modal">Close</button>
                                            <a href="{{ url('add-recruitment-training/edit') }}/{{ $categoryView->recruitment_training_category_id}}"><button type="button" class="btn btn-outline">Sure to edit !</button></a>
                                        </div>
                                    </div>
                                    <!-- /.modal-content -->
                                </div>
