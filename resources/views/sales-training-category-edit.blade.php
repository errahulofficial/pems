...
<div class="col-md-6 d-flex">
    ...
    <div class="box box-primary">
        <div class="box-header with-border d-flex align-items-center">
            <h3 class="box-title col-xs-12 d-flex align-items-center p-0">Edit Sales Training Category</h3>
        </div>
        <div class="col-md-12">
        ...
        {!! Form::open(['action' => ['salesTrainingCategory@update',$categoryView->sales_training_category_id],'id'=>'form']) !!} 
        {{ Form::token() }}
        <div class="box-body">
            <div class="row">
