...
<div class="col d-flex">
    ...
    <div class="box box-primary">
		...
		<ul class="nav nav-tabs">
			  ...
			  <li class="nav-item">
				<a class="nav-link  active" href="<?php echo e(url('contacts')); ?>">Contacts (<?php echo e($prospect->where('commit_stage', '0')->count()); ?>)</a>
			  </li>
			  <li class="nav-item">
...
<div class="col">
<?php $__currentLoopData = $prospect->where('commit_stage', '0'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prospect): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
