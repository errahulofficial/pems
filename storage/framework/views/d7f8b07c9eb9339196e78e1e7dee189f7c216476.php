...
<div class="col-md-6 d-flex">
    <div class="box box-primary">
        ...
        <?php echo Form::open(['action' => ['interviewStatus@update',''.$interviewStatusView->interviewstatusid],'id'=>'form']); ?> <?php echo e(Form::token()); ?>

        <div class="box-body">
            <div class="row">
                <div class="col-md-12 form-group">
                    <label for="name">Name</label> <?php echo e(Form::text('name', $interviewStatusView->interviewstatus_name,array('class' => 'form-control','placeholder'
                    => 'Name','required'=>'true'))); ?>
                ...
                <div class="col-md-12 form-group">
                        ...
                        <div class="colorpicker" id="colorpicker">
                            ...
                            <div class="swatch" id="color" style="background:<?php echo e($interviewStatusView->interviewstatus_colorcode); ?>">
                               </div>
                               
                               <?php echo e(Form::text('colorcode',  $interviewStatusView->interviewstatus_colorcode,array('class' => 'form-control','placeholder' =>
...
<script>
    $(document).ready(function() {
       ...
       $('select[name="step"]').append('<option value="">NULL</option>');
           ...
           $('select[name="jobposition"]').prepend('<option value="<?php echo e($interviewStatusView->interviewstatus_jobPositionId); ?>" selected><?php echo e($interviewStatusView->jobposition_name); ?></option>');
           $('select[name="step"]').append('<option value="<?php echo e($interviewStatusView->interviewstatus_jobPositionStepid); ?>" selected><?php echo e($interviewStatusView->jobpositionstep_stepname); ?></option>');
</script>
...
<script>
        ...
        <script>
        $(document).ready(function() {
$('#colorcode').val('<?php echo e($interviewStatusView->interviewstatus_colorcode); ?>');
$('#color').css('background','<?php echo e($interviewStatusView->interviewstatus_colorcode); ?>');
});</script>
