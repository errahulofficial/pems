            ...
            <div class="box-body">
				...
				<?php echo e(Form::hidden('refer',$refer,array('class' => 'form-control','placeholder'
                    ...
                    <div class="col-md-6 form-group">
                        <label for="fname">First Name</label> <?php echo e(Form::text('fname', '',array('class' => 'form-control','placeholder'
                        => 'First Name'))); ?>
                    ...
                    <div class="col-md-6 form-group">
                        <label for="phone">Best Phone</label> <?php echo e(Form::text('phone', '',array('class' => 'form-control','placeholder'
                        => 'Best Phone'))); ?>

                    </div>
                    <div class="col-md-6 form-group">
                        <label for="zipcode">Zip Code</label> <?php echo e(Form::text('zipcode', '',array('class' => 'form-control','placeholder'
                        => 'Zip Code'))); ?>
                    ...
                    <div class="col-md-6 form-group">
                        <label for="name">Your Resume</label> <?php echo e(Form::file('resume',array('class' => 'form-control','placeholder'
                        => 'Name'))); ?>
