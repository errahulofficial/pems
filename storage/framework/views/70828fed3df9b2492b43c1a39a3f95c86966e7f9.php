...
$("#datepicker2").datepicker({
        ...
        onSelect: function (dateText, inst) {
            ...
            window.open('<?php echo url("interviews/view"."/".$careers_usersId."/".$jobposition."/".$status."/".$interviewer."/".$from_date."/".$to_date); ?>' + '/reschedule/date/' + this.value +'/'+ weekday[date.getUTCDay()], "_self");
        }
    });
});
$(document).ready(function () {
