...
<div class="col-md-8 m-auto" style="margin:auto;float:none">
    ...
    <div class="row">
        <div class="box-body">
            ...
            <h3><?php echo $headfoot->step5_header; ?></h3>
            </div>
                ...
                <h4><?php echo e($i); ?>. <?php echo e($questions_view->question); ?></h4>
                    <?php echo e(Form::radio('survey'.$i.'[]','1',false,array('class' => 'form-control'))); ?> 
                    <label for="see" class="mr-10"> Yes</label>
                    <?php echo e(Form::radio('survey'.$i.'[]','0',false,array('class' => 'form-control ml-10'))); ?> 
                ...
                <div class="form-group col-md-12">
                <h3><?php echo $headfoot->step5_footer; ?></h3>
                </div>
        </div>
