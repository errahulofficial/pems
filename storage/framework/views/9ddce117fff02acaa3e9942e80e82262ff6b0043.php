...
<div class="col d-flex">
    ...
    <div class="box box-primary">
		...
		<ul class="nav nav-tabs">
			  ...
			  <li class="nav-item">
				<a class="nav-link active" href="<?php echo e(url('side-dish')); ?>">Monitoring (<?php echo e($prospect->where('commit_stage', '3')->count()); ?>)</a>
			  </li>
			  <li class="nav-item">
...
<div class="col">
<?php $__currentLoopData = $prospect->where('commit_stage', '3'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prospect): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="box box-success">
       <div class="box-header with-border d-flex align-items-center">
		...
		<ul class="nav nav-tabs">
			  ...
			  <li>
				<span class="det"><a href=""> <i class="fa fa-trash" aria-hodden="true"></i> Delete  </a></span>
			  </li>
			</ul>
